...
```mermaid
flowchart LR
  subgraph ZoneA["Zone A: Ankomst R1–R10"]
    A[Landing → Bro → Kryds]
  end
  subgraph ZoneB["Zone B: Vestfløj R11–R24"]
    B[Forhal → Arkiv → Præster → Spisesal]
  end
  subgraph Korridor["Korridor R25–R40"]
    K[Relieffer → Østfløj → Knoglegrube]
  end
  subgraph Forhal["Forhal R41–R50"]
    F[R41–R44 → R50 Boss]
  end
  ZoneA --- ZoneB
  ZoneA --- Korridor
...
```mermaid
flowchart TB
  subgraph ZoneA["Zone A: R1–R10 Ankomst & motorvej"]
    direction TB
    R1 --- R2
    R1 --- R3
    R3 --- R4
  ...
  subgraph ZoneB["Zone B: R11–R24 Vestfløjen"]
    direction TB
    R11 --- R12
    R12 --- R13
    R13 --- R14
  ...
  subgraph Korridor["Østfløj R25–R40 (realistisk layout)"]
    direction TB
    R25 --- R26
    R26 --- R27
    R26 --- R28  
  ...
  subgraph Forhal["R41–R44 Forhal, R45–R50"]
    direction TB
    R40 --- R41 --- R42 --- R43 --- R44
    R44 --- R45
    R44 --- R46
